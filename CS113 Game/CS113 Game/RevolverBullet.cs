...
namespace CS113_Game
{
    ...
    {
        public RevolverBullet(Game game, Gun source_Weapon, bool target, Vector2 position,
        ...
        {
            this.bullet_Texture = Game1.content_Manager.Load<Texture2D>("Sprites/Projectiles/RevolverBullet");
